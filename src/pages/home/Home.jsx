    ...
    <div className={styles.homeContainer}>
      ...
      <div className={styles.thirdSection}>
        ...
        <h2 className={styles.secondTitle}>Como funciona</h2>
          <div className={styles.firtsTitle}>
          ...
          <div className={styles.everyCards}>
            <div className={styles.thirdFeatures}>
              <div className={styles.featureCard}>
                <h3>🚀 Mobilidade</h3>
                <p>
                  Levamos a loja até os maiores eventos do Brasil, aproximando
                  marcas do público.
                </p>
              </div>
              <div className={styles.featureCard}>
                ...
                <p>
                  O ônibus pode ser customizado por marcas para criar
              ...
              <div className={styles.featureCard}>
                <h3>🔊 Visibilidade</h3>
                <p>
                  DJ e locutor promovem engajamento e tornam o Bus Store o
                  destaque do evento.
                </p>
              </div>
              <div className={styles.featureCard}>
                ...
                <p>
                  Provadores, climatização e infraestrutura completa para uma
                  compra diferenciada.
                </p>
              </div>
            </div>
            ...
            <div className={styles.thirdFeatures}>
              <div className={styles.featureCard}>
                ...
                <p>
                  As marcas podem personalizar o ônibus para ativação em seus
                  eventos.
                </p>
              </div>
              <div className={styles.featureCard}>
                ...
                <p>
                  Oferecemos suporte logístico e estrutural, garantindo a melhor
                  experiência para o público-alvo.
                </p>
              </div>
              <div className={styles.featureCard}>
                <h3>🏬 Modelo de Loja Própria</h3>
                <p>
                  Operamos o Bus Store com nossa linha exclusiva de produtos.
                </p>
              </div>
              <div className={styles.featureCard}>
                <h3>🌍 Presença em Eventos</h3>
                <p>
                  Participamos de eventos esportivos, musicais, culturais e
                  outros de grande alcance.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className={styles.eventsSection}>
        ...
        <div className={styles.eventsList}>
          ...
          <div className={styles.eventCard}>
            ...
            <p>
              Local: USTA Billie Jean King National Tennis Center, Nova York -
              EUA
            </p>
            <button className={styles.eventButton}>Mais informações</button>
          </div>
